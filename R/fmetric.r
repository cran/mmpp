#' Compute Filter-based Metrics in the Functional Space Between Marked Point Processes
#'
#'
...
#' @references M. C. W. van Rossum. 2001. A Novel Spike Distance. Neural Comput. 13, 4 (April 2001), 751-763. 
#' @references S. Schreiber, J.M. Fellous, P.H. Tiesinga, T.J. Sejnowski, A new correlation-based measure of spike timing reliability, Neurocomputing 2003; 52-54:925--31
#' @export
#' @examples
